...
class SocketioManagerBackGround {
  void init(String shop_id, Function func) async {
    IO.Socket socket = IO.io('${HostName()}',
        IO.OptionBuilder().setTransports(['websocket']).build());
    socket.onDisconnect((data) => print("Background service disconnect"));
    socket
        .onReconnect((data) => print("Background service Connecting........"));
    socket.onConnect((_) {
