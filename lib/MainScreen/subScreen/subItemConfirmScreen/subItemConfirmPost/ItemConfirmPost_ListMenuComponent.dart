...
class ItemConfirmPost_ListMenuComponent extends StatefulWidget {
  final GetPostShopItemDataResposne data;
  ItemConfirmPost_ListMenuComponent({@required this.data});

  @override
  _ItemConfirmPost_ListMenuComponentState createState() =>
      _ItemConfirmPost_ListMenuComponentState();
}

class _ItemConfirmPost_ListMenuComponentState
    extends State<ItemConfirmPost_ListMenuComponent> {
  @override
